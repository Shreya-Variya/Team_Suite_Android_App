...
class AttendanceReportViewModel(private val repository: AttendanceReportRepository): BaseViewModel() {
    val attendanceData = MutableLiveData<AttendanceReportResponse>()
    val error = MutableLiveData<String>()
    val loading = MutableLiveData<Boolean>()

    fun getAttendanceReport(empid: String){

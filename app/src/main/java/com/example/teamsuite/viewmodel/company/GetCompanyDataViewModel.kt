package com.example.teamsuite.viewmodel.company
...
class GetCompanyDataViewModel(private var repository: GetCompanyDataRepository): BaseViewModel() {
    val getCompanyDataResult = MutableLiveData<GetCompanyDataResponse>()
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful && response.body() != null){
                    getCompanyDataResult.value = response.body()
                }
                else{

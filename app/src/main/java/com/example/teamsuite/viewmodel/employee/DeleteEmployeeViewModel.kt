...
class DeleteEmployeeViewModel(private var repository: DeleteEmployeeRepository): BaseViewModel() {
    val deleteEmployeeResult = MutableLiveData<DeleteEmployeeResponse>()
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful && response.body() != null){
                    deleteEmployeeResult.value = response.body()
                }
                else{
